...
numeros_pares = [num for num in numero if num % 2 == 0]
pares = list(range(2, 21, 2)) # Otra forma
print(numeros_pares)
...
print("\nEjercicio 4:")
word_more_five = [word for word in palabras if len(word) > 5]
print(word_more_five)
...
print("\nEjercicio 5:")
letter = "c"
filter_word = [word for word in palabras if word[0] == letter]
print(filter_word)